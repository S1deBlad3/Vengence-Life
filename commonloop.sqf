...
while {true} do 
	...
	if ((_Letzterbankmoney != bankmoney) and (bankmoney != StartGeld)) then 

		{
			["bankmoney", bankmoney] spawn ClientSaveVar;	
			_Letzterbankmoney = bankmoney;
		};
	...
	civarray          = [civ1, civ2, civ3, civ4, civ5, civ6, civ7, civ8, civ9, civ10, civ11, civ12, civ13, civ14, civ15, civ16, civ17, civ18, civ19, civ20, civ21, civ22, civ23, civ24, civ25, civ26, civ27, civ28, civ29, civ30, civ31, civ32, civ33, civ34, T100, T1001, T1001_1, T1001_2, T1001_3, T1001_4, T1001_5, T1001_6, T1001_7, T1001_8];
	playerarray 	  =	[civ1, civ2, civ3, civ4, civ5, civ6, civ7, civ8, civ9, civ10, civ11, civ12, civ13, civ14, civ15, civ16, civ17, civ18, civ19, civ20, civ21, civ22, civ23, civ24, civ25, civ26, civ27, civ28, civ29, civ30, civ31, civ32, civ33, civ34, cop1, cop2, cop3, cop4, cop5, cop6, cop7, cop8, cop9, cop10, cop11, cop12, cop13, cop14, cop15, cop16, cop17, cop18, cop19, cop20, T100, T1001, T1001_1, T1001_2, T1001_3, T1001_4, T1001_5, T1001_6, T1001_7, T1001_8];
	...
	if ((player distance getmarkerpos "policebase" < 59 or player distance getmarkerpos "policebase2" < 12 or player distance getmarkerpos "policebase3" < 250 or player distance getmarkerpos "police_area_4" < 900) and isciv and !(_veh isKindOf "Air") and !(_veh isKindOf "Ship")) then 
		...
		if (_veh != player) then 
			...
			player Action ["GET OUT", _veh];
				...
				{
					if(player distance getmarkerpos "policebase" < player distance getmarkerpos "policebase3" ) then
					{
	...
	if (bankmoney > bank_limit) then {bankmoney = bank_limit;player groupChat localize "STRS_maxbank";};
