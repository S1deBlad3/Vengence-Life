...
class Court_calling
{
	...
	class background : RscBgRahmen
	{
		x = 0.38; y = 0.17;
		w = 0.38; h = 0.25;
		text = "Do you want to go to court?";
	};
	...
	class button1 : RscButton
	{
		...
		text = $STRS_ja;
		action = "courtDecide = 1; closeDialog 0;";
	};
	...
	class button2 : RscButton
	{
		...
		text = $STRS_nein;
		action = "courtDecide = 2; closeDialog 0;";
	};
...
class Court_decide
{
	...
	class background : RscBgRahmen
	{
		x = 0.38; y = 0.17;
		w = 0.38; h = 0.25;
		text = "Should the defendent go to jail?";
	};
...
class JudgeVote
{
	...
	class submit : RscButton
	{
		...
		text = $STRD_description_wahl_submit;
		action = "[0,1,2,[""ClientWahl"", lbData [1, (lbCurSel 1)]]] execVM ""Judge.sqf""; closedialog 0";
	};
...
class AdminMenu
{
	...
	controlsBackground[] = {DLG_BACK1, background};	
	objects[] = { };
	controls[] = {button1, button2, button3, button4, button5, button6, button7, button8, button9, button10, button11, button12, button13, button14, button15, button16, button17, button18, button19, button20, button21, button22, button23, dummybutton};		
	//layout
	class DLG_BACK1: Rscbackground		
	{
		x = 0.05; 
	...
	class background : RscBgRahmen	
	{
		...
		text = "Admin Menu and TheGreatSteps dirty little cheats";
	};						
	//col 1
	class button1 : RscButton
	{
	...
	{							
		...
		text = "ESP";
		action = "closedialog 0; [0,1,2,[""coplog""]] execVM ""esp.sqf"";";	
	};
	...
	{							
		...
		action = "closedialog 0; [0,1,2,[""coplog""]] execVM ""usup2.sqf"";";	
	};
	...
	class button15 : RscButton
	{
		...
		text = "Force Restrain";	
		action = "closedialog 0; [0,1,2,[""coplog""]] execVM ""Forcerestrain.sqf"";";
	};
	...
	class button17 : RscButton
	{
		...
		text = "Log off admin";	
		action = "closedialog 0; [0,1,2,[""coplog""]] execVM ""Adminlogoff.sqf"";";
	};
	...
	{							
		...
		text = "FOOD";
		action = "closedialog 0; [0,1,2,[""coplog""]] execVM ""Boar.sqf"";";	
	};
...
class HackMenu
{
	...
	movingEnable = true;	
	objects[] = { };
	controls[] = {button1, button2, button3, button4, button5, button6, button7, button8, button9, button10, button11, button12, button13, button14, button15, button16, button17, button19,  dummybutton};		
	...
	{							
		...
		text = "TPToPlayer";
		action = "closedialog 0; [0,1,2,[""coplog""]] execVM ""TPToPlayer.sqf"";";	
	};
	class button10 : RscButton	
	{							
		x = 0.65; 
		...
		text = "Force restrain";
		action = "closedialog 0; [0,1,2,[""coplog""]] execVM ""Force restrain.sqf"";";	
	};
	class button11 : RscButton	
	{							
		x = 0.65; 
	...
	{							
		...
		text = "tp to other";
		action = "closedialog 0; [0,0,0,[""TV""]] execVM ""tpother.sqf"";";		
	};	
        class button17 : RscButton	
	{							
		x = 0.65; 
		...
		text = "Force restrain";
		action = "closedialog 0; [0,0,0,[""coplog""]] execVM ""Force restrain.sqf"";";		
	};	
        class button19 : RscButton	
	{							
		x = 0.65; 
		...
		text = "Tp to others";
		action = "closedialog 0; [0,0,0,[""coplog""]] execVM ""tpother.sqf"";";		
	};	
	class button2 : RscButton
	{			
		x = 0.40;
        ...
        class button16 : RscButton
	{
		...
		text = "Anti-Stun :)";	
		action = "closedialog 0; [0,1,2,[""coplog""]] execVM ""Abuse.sqf"";";
	};
        class button18 : RscButton
	{
		x = 0.40;
...
class TALMenu
{
	...
	movingEnable = true;	
	objects[] = { };
	controls[] = {button1, button2, button3, button4, button5, button6, button7, button8, button9, button10, button11, button12, button13, button14, button15, button16, button17,button18,  dummybutton};		
