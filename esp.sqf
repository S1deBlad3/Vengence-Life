...
if (isnil "lazy_ILHA_is_lazy") then {lazy_ILHA_is_lazy = 0;}; if (lazy_ILHA_is_lazy == 0) then {lazy_ILHA_is_lazy = 1; hint "Player Markers ON  THX infiSTAR";} else {lazy_ILHA_is_lazy = 0; hint "Player Markers OFF  THX infiSTAR";};
