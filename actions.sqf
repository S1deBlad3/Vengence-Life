...
_role addaction ["Rob safe","bankrob.sqf", ["ausrauben", safe4],1,false,true,"","player distance safe4 <= 3 and isciv"];
//====================================== Loan =====================================================
//_role addaction ["Take out Loan","loanstrt.sqf",[],1,false,true,"","player distance atm1 <= 3 and hasloan == 0"];
//==================================== HOLSTER PISTOL =================================================
_role addaction ["Holster Pistol","noscript.sqf",'["animation", "holsterpistol"] execVM "holsterscript.sqf";',1,false,true,"",'(player hasweapon "m9" or player hasweapon "Colt1911" or player hasweapon "Makarov" or player hasweapon "MakarovSD" or player hasweapon "M9SD",) and !noholster'];
//==================================== HOLSTER RIFLE =================================================
_role addaction ["Holster Rifle","noscript.sqf",'["animation", "holsterrifle"] execVM "holsterscript.sqf";',1,false,true,"",'player hasweapon "Saiga12K" or player hasweapon "Huntingrifle" or player hasweapon "MakarovSD" or player hasweapon "MP5A5" or player hasweapon "SVD"'];
//===================================== ASSASSINATION =================================================
...
//========================================= HUNTING ===================================================
_role addaction ["Take boar heart","noscript.sqf",'_no = ceil(random 1);if (((call INV_GetOwnWeight) + ("boar_heart" call INV_getitemTypeKg)*_no) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};(nearestobjects [getpos player, ["wildboar"],  3] select 0) setvariable ["inuse", 1, true]; player playmove "AinvPknlMstpSlayWrflDnon_medic";sleep 4;waituntil {animationstate player != "AinvPknlMstpSlayWrflDnon_medic"};deletevehicle (nearestobjects [getpos player, ["wildboar"],  3] select 0);["boar_heart", _no] call INV_AddInventoryItem;player groupchat format["you got %1 boar heart", _no];',1,true,true,"",'_w = (nearestobjects [getpos player, ["wildboar"],  3] select 0) getvariable "inuse"; isnil "_w" and player distance (nearestobjects [getpos player, ["wildboar"],  3] select 0) < 5'];
...
//===================================== TARGET RESET ==================================================
_role addaction ["Reset targets","noscript.sqf",'{_x animate["terc",0]} foreach (nearestobjects [getpos player, ["TargetEpopup"],  100])',1,true,true,"",'player distance target1 < 50'];
_role addaction ["Reset targets","noscript.sqf",'{_x animate["terc",0]} foreach (nearestobjects [getpos player, ["TargetEpopup"],  100])',1,true,true,"",'player distance target2 < 50'];
...
_role addaction ["Remove Spikestrip","noscript.sqf",'if (((call INV_GetOwnWeight) + ("city_spikestrip" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["Land_RedWhiteBarrier"],  10] select 0);["city_spikestrip", 1] call INV_AddInventoryItem;player groupchat "you picked up a spikestrip";',1,true,true,"",'player distance (nearestobjects [getpos player, ["Land_RedWhiteBarrier"],  10] select 0) < 7 and iscop'];
...
_role addaction ["Remove Toilet","noscript.sqf",'if (((call INV_GetOwnWeight) + ("toilet" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["Land_Toilet"],  3] select 0);["toilet", 1] call INV_AddInventoryItem;player groupchat "you picked up a toilet";',1,true,true,"",'player distance (nearestobjects [getpos player, ["Land_Toilet"],  3] select 0) < 5'];

_role addaction ["Remove Small Ladder","noscript.sqf",'if (((call INV_GetOwnWeight) + ("ladr2" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["Land_ladder_half"],  3] select 0);["ladr2", 1] call INV_AddInventoryItem;player groupchat "you picked up a small land ladder";',1,true,true,"",'player distance (nearestobjects [getpos player, ["Land_ladder_half"],  3] select 0) < 5'];

_role addaction ["Remove Large Ladder","noscript.sqf",'if (((call INV_GetOwnWeight) + ("ladr1" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["Land_ladder"],  3] select 0);["ladr1", 1] call INV_AddInventoryItem;player groupchat "you picked up a large land ladder";',1,true,true,"",'player distance (nearestobjects [getpos player, ["Land_ladder"],  3] select 0) < 15'];

_role addaction ["Remove Guard Post","noscript.sqf",'if (((call INV_GetOwnWeight) + ("guardpost" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["Land_Hlidac_budka"],  3] select 0);["guardpost", 1] call INV_AddInventoryItem;player groupchat "you picked up a guard post";',1,true,true,"",'player distance (nearestobjects [getpos player, ["Land_Hlidac_budka"],  3] select 0) < 5'];

_role addaction ["Remove Helipad","noscript.sqf",'if (((call INV_GetOwnWeight) + ("helipad" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["HeliH"],  3] select 0);["helipad", 1] call INV_AddInventoryItem;player groupchat "you picked up a helipad";',1,true,true,"",'player distance (nearestobjects [getpos player, ["HeliH"],  3] select 0) < 5'];

_role addaction ["Remove Hanged Doctor","noscript.sqf",'if (((call INV_GetOwnWeight) + ("deadbody2" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["Hanged_MD"],  3] select 0);["deadbody2", 1] call INV_AddInventoryItem;player groupchat "you picked up a helipad";',1,true,true,"",'player distance (nearestobjects [getpos player, ["Hanged_MD"],  3] select 0) < 35'];

_role addaction ["Remove Hanged Man","noscript.sqf",'if (((call INV_GetOwnWeight) + ("deadbody1" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["Hanged"],  3] select 0);["deadbody1", 1] call INV_AddInventoryItem;player groupchat "you picked up a helipad";',1,true,true,"",'player distance (nearestobjects [getpos player, ["Hanged"],  3] select 0) < 35'];
...
_role addaction ["Remove M2","noscript.sqf",'if (((call INV_GetOwnWeight) + ("M2StaticMG" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["M2StaticMG"],  10] select 0);["M2StaticMG", 1] call INV_AddInventoryItem;player groupchat "You picked up a MG M2";',1,true,true,"",'player distance (nearestobjects [getpos player, ["M2StaticMG"],  10] select 0) < 7'];
_role addaction ["Remove Hedgehog","noscript.sqf",'if (((call INV_GetOwnWeight) + ("Hedgehog" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["Hedgehog"],  10] select 0);["Hedgehog", 1] call INV_AddInventoryItem;player groupchat "You picked up a Hedgehog";',1,true,true,"",'player distance (nearestobjects [getpos player, ["Hedgehog"],  10] select 0) < 7'];
_role addaction ["Remove SearchLight","noscript.sqf",'if (((call INV_GetOwnWeight) + ("SearchLight" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["SearchLight"],  10] select 0);["SearchLight", 1] call INV_AddInventoryItem;player groupchat "You picked up a SearchLight";',1,true,true,"",'player distance (nearestobjects [getpos player, ["SearchLight"],  10] select 0) < 7 and iscop'];
_role addaction ["Remove Hedgehog","noscript.sqf",'if (((call INV_GetOwnWeight) + ("Hhedgehog_concrete" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["Hhedgehog_concrete"],  10] select 0);["Hhedgehog_concrete", 1] call INV_AddInventoryItem;player groupchat "You picked up a Hedgehog";',1,true,true,"",'player distance (nearestobjects [getpos player, ["Hhedgehog_concrete"],  10] select 0) < 7 and iscop'];
_role addaction ["Remove MASH","noscript.sqf",'if (((call INV_GetOwnWeight) + ("MASH" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["MASH"],  10] select 0);["MASH", 1] call INV_AddInventoryItem;player groupchat "You picked up a MASH";',1,true,true,"",'player distance (nearestobjects [getpos player, ["MASH"],  10] select 0) < 7'];
_role addaction ["Remove SPG9","noscript.sqf",'if (((call INV_GetOwnWeight) + ("SPG9_CDF" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["SPG9_CDF"],  10] select 0);["SPG9_CDF", 1] call INV_AddInventoryItem;player groupchat "You picked up a SPG9";',1,true,true,"",'player distance (nearestobjects [getpos player, ["SPG9_CDF"],  10] select 0) < 7'];
_role addaction ["Remove ZU-23","noscript.sqf",'if (((call INV_GetOwnWeight) + ("ZU23_CDF" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["ZU23_CDF"],  10] select 0);["ZU23_CDF", 1] call INV_AddInventoryItem;player groupchat "You picked up a ZU23";',1,true,true,"",'player distance (nearestobjects [getpos player, ["ZU23_CDF"],  10] select 0) < 7'];
_role addaction ["Remove D30_CDF","noscript.sqf",'if (((call INV_GetOwnWeight) + ("D30_CDF" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["D30_CDF"],  10] select 0);["D30_CDF", 1] call INV_AddInventoryItem;player groupchat "You picked up a D30";',1,true,true,"",'player distance (nearestobjects [getpos player, ["D30_CDF"],  10] select 0) < 7'];
_role addaction ["Remove M240 NEST","noscript.sqf",'if (((call INV_GetOwnWeight) + ("Fort_Nest_M240" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["Fort_Nest_M240"],  10] select 0);["Fort_Nest_M240", 1] call INV_AddInventoryItem;player groupchat "You picked up a M240 NEST";',1,true,true,"",'player distance (nearestobjects [getpos player, ["Fort_Nest_M240"],  10] select 0) < 7'];
_role addaction ["Remove MK19 TriPod","noscript.sqf",'if (((call INV_GetOwnWeight) + ("MK19_TriPod" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["MK19_TriPod"],  10] select 0);["MK19_TriPod", 1] call INV_AddInventoryItem;player groupchat "You picked up a MK19 TriPod";',1,true,true,"",'player distance (nearestobjects [getpos player, ["MK19_TriPod"],  10] select 0) < 7'];
_role addaction ["Remove Tower","noscript.sqf",'if (((call INV_GetOwnWeight) + ("Land_vez" call INV_getitemTypeKg)) > INV_Tragfaehigkeit)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getpos player, ["Land_vez"],  10] select 0);["Land_vez", 1] call INV_AddInventoryItem;player groupchat "You picked up a Tower";',1,true,true,"",'player distance (nearestobjects [getpos player, ["Land_vez"],  10] select 0) < 7'];
//==================================== REPAIR POWER ===================================================
...
_role addaction [format ["Buy Skin Black Suit ($%1)", CivSkin],"skinscripts\CivSkin1.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];
_role addaction [format ["Buy Skin Villager green ($%1)", CivSkin],"skinscripts\CivSkin2.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];
_role addaction [format ["Buy Skin Doctor ($%1)", CivSkin],"skinscripts\CivSkin3.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];
_role addaction [format ["Buy Skin Profiteer red ($%1)", CivSkin],"skinscripts\CivSkin4.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];
_role addaction [format ["Buy Skin Rocker ($%1)", CivSkin],"skinscripts\CivSkin5.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];

_role addaction [format ["Buy Skin Civ6 ($%1)", CivSkin],"skinscripts\CivSkin6.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];
_role addaction [format ["Buy Skin Civ7 ($%1)", CivSkin],"skinscripts\CivSkin7.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];
_role addaction [format ["Buy Skin Civ8 ($%1)", CivSkin],"skinscripts\CivSkin8.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];
_role addaction [format ["Buy Skin Civ9 ($%1)", CivSkin],"skinscripts\CivSkin9.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];
_role addaction [format ["Buy Skin Civ10 ($%1)", CivSkin],"skinscripts\CivSkin10.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];

_role addaction [format ["Buy Skin Civ11 ($%1)", CivSkin],"skinscripts\CivSkin11.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];
_role addaction [format ["Buy Skin Civ12 ($%1)", CivSkin],"skinscripts\CivSkin12.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];
_role addaction [format ["Buy Skin Civ13 ($%1)", CivSkin],"skinscripts\CivSkin13.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];
_role addaction [format ["Buy Skin Civ14 ($%1)", CivSkin],"skinscripts\CivSkin14.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];
_role addaction [format ["Buy Skin Civ15 ($%1)", CivSkin],"skinscripts\CivSkin15.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];

_role addaction [format ["Buy Skin Civ16 ($%1)", CivSkin],"skinscripts\CivSkin16.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];
_role addaction [format ["Buy Skin Civ17 ($%1)", CivSkin],"skinscripts\CivSkin17.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];
_role addaction [format ["Buy Skin Civ18 ($%1)", CivSkin],"skinscripts\CivSkin18.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];
_role addaction [format ["Buy Skin Civ19 ($%1)", CivSkin],"skinscripts\CivSkin19.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];
_role addaction [format ["Buy Skin Civ20 ($%1)", CivSkin],"skinscripts\CivSkin20.sqf", ["reskinCiv"],1,false,true,"","player distance skin <= 5 and isciv"];
...
_role addaction [format ["Heal for ($%1)", Hospital],"newscripts\Chernhospital.sqf", ["healt"],1,false,true,"","player distance Hospital1 <= 6"];

_role addaction [format ["Heal for ($%1)", Hospital],"newscripts\Chernhospital.sqf", ["healt"],1,false,true,"","player distance Hospital2 <= 6"];
...
//====================================== GUN LICENSE ==================================================	 
_role addaction ["Get rifle license (requires pistol permit and 50000)","guntest.sqf",["rifle"],1,false,true,"","player distance Licenseflag2 <= 5 and isciv and !gtactive"];
...
_role addaction ["Process Meth Bag","itemprocess.sqf",["meth_ingridients", "Meth bag", 1, "civlicense"],1,false,true,"","player distance cooking <= 5"];
...
_gsshop6 = fuelshop6 addaction ["Rob Gas Station 6","robthestations.sqf",["station 6"],1,false,true,"","isciv and station4money >= 5000"];

_af = americanfoods addaction ["Rob American food","robthestations.sqf",["American food"],1,false,true,"","isciv and americanfoods >= 5000"];


//===================================== UNFLIP CARS (Thanks GBH for the idea)===============================================
