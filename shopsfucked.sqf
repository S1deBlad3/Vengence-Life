...
_emptyshop = [];
_fs = ["kanister", "kleinesreparaturkit", "reparaturkit","ziptie"];
_is = ["Apfel","Apfelkuchen","blowfish", "mackerel", "herring", "bass", "Bread", "rabbit", "boar", "medikit", "handy","Lemon","Pinapple","Orange","Banana"];
...
_pps1 = ["datsun1_civil_1_open", "datsun1_civil_2_covered", "hilux1_civil_1_open", "hilux1_civil_2_covered", "UAZ_RU", "HMMWV"];
...
_tn2 = ["Binocular", "GPS", "NVGoggles", "AK_47_M","AKS_GOLD","30Rnd_762x39_AK47","RPG7V", "PG7V","lockpick"];
_ts = ["Ikarus", "UralCivil", "UralCivil2", "V3S_Civ", "KamazOpen","MTVR","MtvrRepair"];
_ttt2 = ["Ikarus", "UralCivil", "UralCivil2", "KamazOpen","V3S_Civ","MTVR","MtvrRepair"];
...
_tbs = ["T72_INS","Mi17_medevac_Ins","Mi17_Ins","Kamaz","BRDM2_INS","UAZ_RU","HMMWV","Offroad_DSHKM_INS","Pickup_PK_INS"];
_bc = ["PBX", "Zodiac", "RHIB"];
...
_sa1 = ["MH60S","Mi24_V","Pchela1T"];
_cv = ["MMT_USMC","M1030","LadaLM","hilux1_civil_3_open","UAZ_CDF","Kamaz","GAZ_Vodnik_MedEvac","MTVR","MtvrRepair","MtvrReammo","MtvrRefuel" ,"LAV25"];
_sv1 = ["HMMWV", "HMMWV_Armored","BRDM2_CDF","GAZ_Vodnik_HMG", "BMP2_Ambul_CDF", "HMMWV_Avenger""LAV25"];
...
_tv = ["MMT_Civ","Offroad_DSHKM_INS","BRDM2_INS","Mi17_CDF","GAZ_Vodnik","UAZ_AGS30_RU"];
_tcv = ["Offroad_DSHKM_INS","BRDM2_INS","Mi17_CDF","Offroad_SPG9_Gue"];
_ees = ["Body","Hanged","KORD"];
_tchs = ["MH60S"];
_logs = ["Axe_woodblock"];
_stuntun12 = ["M9SD","15Rnd_9x19_M9SD","MP5SD","30rnd_9x19_MP5SD","VSS_vintorez","10Rnd_9x39_SP5_VSS","Bizon_Silenced","64Rnd_9x19_SD_Bizon"];
_copwep = ["M2StaticMG","Searchlight","Hhedgehog_concrete","Hedgehog"];
_medcar = ["GAZ_Vodnik_MedEvac","Lada1"];
_nspdmon = ["whale1","moneh"];
_lms = ["Landmine"];
_tdf = ["supgrade10","M2StaticMGT","SearchLightT","Stinger_Pod","D30_CDF","ZU23_CDF","TOW_TriPod","Fort_Nest_M240","MK19_TriPod","SPG9_CDF","GuerillaCacheBox","USSpecialWeaponsBox","USLaunchersBox","USOrdnanceBox","SpecialWeaponsBox","Hhedgehog_concreteT","BarricadeT"];
_black = ["lockpick","M4A1"];
_Medical = ["meth_ingridients"];
_Medical2 = ["Illigal_meth_ingridients"];
_bst1 = ["PBX", "Zodiac", "RHIB"];
_gsaiw1 = ["Binocular","GPS","NVGoggles","Colt1911","Rnd_45ACP_1911","Saiga12K","Rnd_B_Saiga12_74Slug","AK_47_M","30Rnd_762x39_AK47","HandGrenade_East","medikit","kleinesreparaturkit","reparaturkit","kanister","lockpick"];
_gsaiw2 = ["Binocular","GPS","NVGoggles","Colt1911","Rnd_45ACP_1911","Saiga12K","Rnd_B_Saiga12_74Slug","AK_47_M","30Rnd_762x39_AK47","HandGrenade_East","medikit","kleinesreparaturkit","reparaturkit","kanister","lockpick"];
_gsaiw3 = ["Binocular","GPS","NVGoggles","Colt1911","Rnd_45ACP_1911","Saiga12K","Rnd_B_Saiga12_74Slug","AK_47_M","30Rnd_762x39_AK47","HandGrenade_East","medikit","kleinesreparaturkit","reparaturkit","kanister","lockpick"];
...
[picky,"Pickup Shop In High Quality",dummyobj,pickupspawn1,_pps1,_pps1,true],
...
[trucky,"Truck Shop New And Improved",dummyobj,truckspawn2,_ttt2,_ttt2,true],
...
[gangarea1,"Gang Shop",gangbox1,dummyobj,_black,_black,false],
[gangarea2,"Gang Shop",gangbox2,dummyobj,_black,_black,false],
[gangarea3,"Gang Shop",gangbox3,dummyobj,_black,_black,false],
...
[snuff,"Generic Police Shop13131",gangbox1,dummyobj, _copshop,_copshop,false],

[scuff,"Generic Police Shop23123",gangbox2,dummyobj, _copshop,_copshop,false],
...
[swatair,"SWAT Air-Vehicles Shop",dummyobj, saairspawn,_sa1,_sa1,true],
...
[raparap2,"Gang Shop Work",terr1,dummyobj,_gangshop_buy,_gangshop_buy,false],
[stunningcop,"Criminal Response (Stun Weps) High Quality",stunningcop,dummyobj,_stuntun,_stuntun,true],
...
[Methseller,"Sell Drugs",dummyobj,dummyobj,_emptyshop,_meth,true],
[emptyShop,"Gang Shop",dummyobj,dummyobj,_gangshop_buy,_gangshop_buy,true],
...
[TalonVS,"Lancers donator Vehicle Shop",dummyobj,Tcv,_tcv,_tcv,true],
[EasterEggShop,"Easter Egg Shop",dummyobj,dummyobj,_ees,_ees,true],
[emptyShop,"Gang Shop",dummyobj,dummyobj,_gsaiw12,_gsaiw12,true],
[emptyShop,"Gang Shop",dummyobj,dummyobj,_gsaiw12,_gsaiw12,true],
[TalonHS,"Talon Clan Shop",dummyobj,tcHs,_tchs,_tchs,true],
[defenseweapon,"Defensive Non Lethal Weapon",defenseweapon,dummyobj,_stuntun12,_stuntun12,true],
...
[BlackM,"Black market",gunbox20,dummyobj,_market,_market,true],
[Lowend,"Black market",gunbox21,dummyobj,_lowend,_lowend,true],
[Highend,"Black market",gunbox23,dummyobj,_highend,_highend,true],
[Explosive,"Black market",dummyobj,dummyobj,_explosive,_explosive,true],
