...
Hochverschieben 	= player addaction ["Move 1 meter up", "noscript.sqf",'_pos=[ (position lastbuilding select 0), (position lastbuilding select 1) , ((position lastbuilding select 2)  + 1)] ; lastbuilding setpos _pos;'];
ThreeUp  	        = player addaction ["Move 3 meter up", "noscript.sqf",'_pos=[ (position lastbuilding select 0), (position lastbuilding select 1) , ((position lastbuilding select 2)  + 3)] ; lastbuilding setpos _pos;'];
...
OneDown         	= player addaction ["Move 1 meter down", "noscript.sqf",'_pos=[ (position lastbuilding select 0), (position lastbuilding select 1) , ((position lastbuilding select 2) - 1)] ; lastbuilding setpos _pos;'];
...
Ende 				= player addaction ["Exit", "noscript.sqf",'player removeaction Rechtsverschieben; player removeaction Linksverschieben;player removeaction Vorverschieben;player removeaction Rueckverschieben;player removeaction Runterverschieben;player removeaction Hochverschieben;player removeaction Ende;player removeaction Rotierenrechts; player removeaction Rotierenlinks; player removeaction ThreeUp; player removeaction OneDown; player removeaction Rotierenzuspieler; playerbaut = false;'];
