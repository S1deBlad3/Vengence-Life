...
eigene_zeit              = time;				
money_limit              = 250000000;
bank_limit		 = 250000000; 										
wantedbonus              = 3000;         														
StunActiveTime           = 0;  
StunTimePerHit		 = 20; 
MaxStunTime		 = 60;        									 				
GeldStehlenMax           = 250000000;
demerits                 = 0;
gtbonus 		 = 10;
gtactive		 = false;
keyblock		 = false;
...
if ((iscop) and (_UID in validUIDList)) then {
	...
	player groupChat format["%1, you have been banned from becoming an officer.", name player];
};
...
CopStartGear_Weap        = ["M1014","ItemGPS"];
...
TankenCost = 200; publicvariable "TankenCost";
bombactive = false; publicvariable "bombactive";

onplayerconnected " 
sleep 10;
publicVariable 'copsallowed';
