_art         = _this select 0;
_stunbullets = [ "B_12Gauge_74Slug", "B_12Gauge_74Slug", "B_9x19_SD", "B_9x18_SD", "B_9x39_SP5",1, "B_30mm_AP", "M4A1_HWS_GL_SD_CAMO", "64Rnd_9x19_SD_Bizon"]; 
...
if(player distance copbase1 < 55 and iscop and vehicle player == player) exitwith
...
if(player distance civspawn < 20 and _wep != "M1014" and _wep != "MakarovSD" and _wep != "VSS_vintorez" and _wep != "MP5SD") exitwith																																																		
