...
while {true} do 
	...
	if(VIPtarget distance getmarkerpos "policebase" < 100) exitwith
		...
		if (iscop) then {bankmoney = (bankmoney + _copbonus); player sidechat format[""you received $%1 for the successful rescue of the VIP"", _copbonus];};
		" call broadcast;
		sleep 2;
